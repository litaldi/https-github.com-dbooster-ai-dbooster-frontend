...
import { BarChart3, Database, Shield, Users, TrendingUp, Activity } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">Welcome to your DBooster dashboard</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest optimizations and system events
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">Query optimization completed</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <span className="text-sm">New database connection added</span>
              </div>
              <div className="flex items-center gap-3">
